...
/**
 * Add or update a memory file
 * @param {Object} file - File object with name, path, content, agent
 * @returns {Promise<Object>} Created/updated memory file
 */
...
/**
 * Get a single memory file by name
 * @param {string} name - File name
 * @returns {Promise<Object>} Memory file
 */
